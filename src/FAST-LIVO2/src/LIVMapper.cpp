...
{
  // std::cout<<"LidarMeasures.lio_vio_flg = "<<LidarMeasures.lio_vio_flg<<std::endl;
...
void LIVMapper::standard_pcl_cbk(const sensor_msgs::PointCloud2::ConstPtr &msg)
{
  ...
  // if(lid_raw_data_buffer.size()>10){
  //   lid_raw_data_buffer.pop_front();
  // }

  // if(lid_header_time_buffer.size()>10){
  //   lid_header_time_buffer.pop_front();

  // }

  // std::cout<<"lid_raw_data_buffer.size = "<<lid_raw_data_buffer.size()<<std::endl;
  // std::cout<<"lid_header_time_buffer.size = "<<lid_header_time_buffer.size()<<std::endl; 
...
void LIVMapper::img_cbk(const sensor_msgs::ImageConstPtr &msg_in)
{
  ...
  // std::cout<<"img_buffer.size = "<<img_buffer.size()<<std::endl;
  // std::cout<<"img_time_buffer.size = "<<img_time_buffer.size()<<std::endl;
